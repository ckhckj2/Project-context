...
const flows={
  "overview": {
    "title": "심의·평가를 한꺼번에 “대상”이라고 단정하지 마세요",
    "steps": [
      [
        "원 승인경로",
        "건축허가·사업계획승인·특별법 사업 등"
      ],
      [
        "프로젝트 조건",
        "위치·용도·규모·공공성·개발사업 여부"
      ],
      [
        "심의 후보",
        "건축·경관·소방·교통·환경·교육·재해·BF·ZEB"
      ],
      [
        "관할 기준",
        "법령 + 시행령 + 조례 + 기관 접수 안내"
      ...
      [
        "일정·도서 연결",
        "누가 준비하고 무엇이 설계에 다시 반영되는지"
      ]
    ]
  },
  "permit": {
    "title": "인허가 업무를 받으면 제출목록부터 만들지 마세요",
    "steps": [
      [
        "원 승인·허가 경로 확인",
        "건축허가/신고, 사업계획승인, 정비사업, 공항·물류 등 특별법 사업"
      ],
      [
        "현재 단계 확인",
        "심의 → 허가·승인 → 착공 → 사용승인·사용검사 → 변경"
      ],
      [
        "심의·평가 후보 확인",
        "대상 여부와 선후행·병행 관계를 일정에 올리기"
      ],
      [
        "자료를 담당별로 쪼개기",
        "건축 기본자료 / 협력업체 / 행정자료 / 추가 요구자료"
      ],
      [
        "제출·보완·반영 추적",
        "제출본 기준일 통일 → 보완 → 설계반영 → 다음 절차 연결"
      ]
    ]
  }
};
const practice={
  "title": "이 업무에서는 원 승인경로 → 심의·평가 → 제출단계 순으로 연결하세요.",
  "steps": [
    "기존 승인/허가 문서에서 법적 경로 확인",
    "현재 단계와 선행 심의·평가 후보 확인",
    "관할기관 최신 제출안내로 자료목록 확정"
  ]
};
