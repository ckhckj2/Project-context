...
for(const file of scripts){
  ...
  if(['judgement-data.js','judgement-engine.js','work-rules.js','work-model.js','level-policy.js','bim-rules.js','review-rules.js','public-rules.js','search-answer.js'].includes(file)){vm.runInContext(source,sandbox,{filename:file});continue;}
...
const cases=[
 ...
 ['Revit 중앙파일 작업','bim'],
 ['입면 사례 조사','precedent'],
 ['물류 센터 입면사례 찾으래','precedent'],
 ['운수시설 중간설계 사례를 조사하래요','precedent'],
 ['병원 평면 사례 찾아와','precedent'],
 ['입면사레 찾아오래','precedent'],
 ['입면 사례 말고 도면 고치래','specific'],
 ['계획설계 도면 고치래','specific'],
 ['평면도를 수정해달래','specific'],
 ['보고용 자료 만들어달래','specific'],
 ['입면 사례는 누구에게 물어봐?','ask'],
